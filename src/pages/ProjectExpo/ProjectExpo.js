    ...
    return (
        <div className='hackinfinity-section'>
            ...
            <div className='hi-about'>
                <p className='hi-about-para'>Get ready to witness innovation and creativity like never before at  <span style={{color: 'orange'}}>PROJECT EXPO 2025</span>!! <br></br> This one-of-a-kind event emphasizes cutting-edge ideas and impactful participation, redefining excellence in engineering and technology!</p>
                <br/>
                ...
                {/* <p className='hi-about-para'>COMING SOON!!</p> */}
                
                <a className='hi-link' href='/project-expo'> 
